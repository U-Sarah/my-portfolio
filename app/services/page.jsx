      ...
      <div className="container mx-auto w-full flex flex-col gap-16">
        ...
        <div className="flex flex-col xl:flex-row justify-between items-start xl:items-center gap-8">
          ...
          <h2 className="h2 max-w-[480px] text-left xl:mb-0">
            Custom <span className="text-[#5810ff] ">Web Solutions</span> to
            Boost Your Business
          </h2>
          {/* btn */}
          ...
          {services.map((item, index) => {
            return (
              <SwiperSlide key={index}>
                <div
                  className="bg-[#140e25]/90 w-full h-[284px] rounded-[20px] px-[30px] py-[40px]
              flex flex-col justify-between"
                >
                  <div className="flex items-center justify-between mb-12">
                    <Image src={item.icon} width={48} height={48} alt="" />
                    <div className="w-12 h-12 bg-[#5810ff] rounded-full flex items-center justify-center
                    cursor-pointer text-2xl hover:rotate-45 transition-all">
