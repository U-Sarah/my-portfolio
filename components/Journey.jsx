const journey = [
  {
    years: "2025 - Present",
    role: "Web Developer",
    institution: "MHP Const. Ltd",
  },
  {
    years: "2024 - 2025",
    role: "Web Developer and Student",
    institution: "Early Bell Academy",
  },
  {
    years: "2022 - 2024",
    role: "Web Developer",
  ...
  return (
    <div className="flex flex-col">
      <h2 className="h2 mb-8">
        Education & <span className="text-[#5810ff]">Experience</span>
      </h2>
        ...
        return (
          <div key={index} className="flex items-center gap-12 w-full">
            ...
            <div className="flex flex-col w-max justify-center items-center">
              <div className="w-3 h-3 bg-[#5810ff] rounded-full"></div>
